...
export default function ClassHome({ pageName }) {
    return (
        <>
            <div className={styles.wrapper} style={{ zIndex: 1 }}>
                <div className={styles.area}>
                </div>

                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1280 600" preserveAspectRatio="xMaxYMin meet" className={styles.svg}>
                    <defs>
                        ...
                        <linearGradient id="gradient_cloud3" x1="624.83" y1="567.32" x2="624.83" y2="818.88" gradientUnits="userSpaceOnUse">
                            <stop offset="0" stopColor="#fff4ff" />
                            <stop offset="1" stopColor="#ded7e5" />
                        </linearGradient>
                    ...
                    {/* <!-- CLOUDS --> */}
                    <use xlinkHref="#cloud" id="cloud1" className={styles.cloud1} fill="url(#gradient_cloud1)" x="-40" y="-100" />
                    <use xlinkHref="#cloud" id="cloud2" className={styles.cloud2} fill="url(#gradient_cloud2)" x="40" y="-60" />
                    <use xlinkHref="#cloud" id="cloud3" className={styles.cloud3} fill="url(#gradient_cloud3)" x="0" y="0" />
