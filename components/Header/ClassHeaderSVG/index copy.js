            ...
            <div className={styles.wrapper}>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1280 600" preserveAspectRatio="xMaxYMin meet" className={styles.svg}>
                    ...
                    {/* <g className={styles.clouds}>
                        <use xlinkHref="#cloud" id="cloud1" className={styles.cloud1} fill="url(#gradient_cloud1)" x="-40" y="-140" />
                        <use xlinkHref="#cloud" id="cloud2" className={styles.cloud2} fill="url(#gradient_cloud2)" x="40" y="-100" />
                        <use xlinkHref="#cloud" id="cloud3" className={styles.cloud3} fill="url(#gradient_cloud3)" x="0" y="-40" />
                    </g> */}
